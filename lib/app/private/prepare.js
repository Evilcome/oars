...
module.exports = function (oars) {
  ...
  function Prepare() {
    ...
    this.prepareInfo = function(cb) {
      ...
      oars.info = {
        ...
        paths: {
          ...
          // for responses
          responses: path.resolve(appPath, 'api/responses')
        }
      };
    ...
    this.prepareModules = function(cb) {
      ...
      async.parallel({
        ...
        responses: prepare.loadResponses
    ...
    this.loadResponses = function (cb) {
      buildDictionary.optional({
        dirname: oars.info.paths.responses,
        filter: /(.+)\.(js|coffee|litcoffee)$/,
  ...
  Prepare.prototype.bindMiddleware = function() {
    
  }

  Prepare.prototype.bindRoutes = function() {
