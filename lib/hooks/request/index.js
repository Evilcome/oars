...
wise to abstract these built-in Oars functions in a more declarative way, maybe even outside of hooks altogether.
...
module.exports = function(oars) {
  ...
  return {
    ...
    initialize: function(cb) {
      ...
      oars.on('router:route', function(requestState) {
